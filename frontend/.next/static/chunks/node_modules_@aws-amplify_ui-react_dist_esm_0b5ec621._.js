 ...
 */ const useDeprecationWarning = (param)=>{
    let { message, shouldWarn: _shouldWarn } = param;
...
const getCSSVariableIfValueIsThemeKey = (propKey, value, tokens)=>{
    ...
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$types$2f$theme$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isThemeStylePropKey"])(propKey)) {
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2f$dist$2f$esm$2f$theme$2f$createTheme$2f$utils$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isDesignToken"])(tokenProps) ? "var(--".concat((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2f$dist$2f$esm$2f$theme$2f$createTheme$2f$utils$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cssNameTransform"])({
            path: [
...
;
;
const getClosestValueByBreakpoint = (param)=>{
    let { breakpoint, breakpoints, values } = param;
...
const getValueAtCurrentBreakpoint = (param)=>{
    let { breakpoint, breakpoints, values } = param;
...
const getMediaQueries = (param)=>{
    let { breakpoints } = param;
    ...
    return sortedBreakpoints.map((breakpoint, index)=>{
        ...
        if (maxWidth !== null) {
            ...
            query += "(max-width: ".concat(maxWidth, "px)");
        }
        return {
            breakpoint,
            query,
...
const useBreakpoint = (param)=>{
    let { breakpoints, defaultBreakpoint } = param;
    ...
    useIsomorphicEffect({
        "useBreakpoint.useIsomorphicEffect": ()=>{
            ...
            const unsubscribeList = mediaQueries.map({
                "useBreakpoint.useIsomorphicEffect.unsubscribeList": (param)=>{
                    let { query, breakpoint } = param;
 ...
 */ const getStyleValue = (param)=>{
    let { value, propKey, tokens } = param;
...
const convertGridSpan = (spanValue)=>{
    ...
    if (typeof spanValue === 'object' && spanValue != null) {
        return Object.entries(spanValue).reduce((acc, param)=>{
            let [key, value] = param;
            return {
                ...acc,
 ...
 */ const convertStylePropsToStyleObj = (param)=>{
    let { props = {}, style = {}, breakpoint, breakpoints, tokens } = param;
    const nonStyleProps = {};
...
;
;
const ViewPrimitive = (param, ref)=>{
    let { as = 'div', children, testId, ariaLabel, isDisabled, style, inert, ...rest } = param;
...
const LoaderPrimitive = (param, ref)=>{
    let { className, filledColor, emptyColor, size, variation, isDeterminate = false, isPercentageTextHidden = false, percentage = 0, ...rest } = param;
    percentage = Math.min(percentage, 100);
    percentage = Math.max(percentage, 0);
    const percent = "".concat(percentage, "%");
    ...
    const circularLoader = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"]("g", null, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"]("circle", {
        ...
        cy: "50%",
        r: "".concat(RADIUS, "%"),
        strokeWidth: "".concat(CIRCULAR_STROKE_WIDTH, "%"),
        style: {
            stroke: String(emptyColor)
        },
        ...
        style: {
            ...
            strokeDasharray: isDeterminate ? "".concat(CIRCUMFERENCE, "% ").concat(CIRCUMFERENCE, "%") : undefined,
            strokeDashoffset: isDeterminate ? "".concat(CIRCUMFERENCE - CIRCUMFERENCE * percentage / 100, "%") : undefined
        },
...
const ButtonPrimitive = (param, ref)=>{
    let { className, children, colorTheme, isFullWidth = false, isDisabled, isLoading, loadingText = '', size, type = 'button', variation, ...rest } = param;
    ...
    var _ref;
    const shouldBeDisabled = isFieldsetDisabled ? isFieldsetDisabled : (_ref = isDisabled !== null && isDisabled !== void 0 ? isDisabled : isLoading) !== null && _ref !== void 0 ? _ref : rest['disabled'];
...
const HeadingPrimitive = (param, ref)=>{
    let { className, children, isTruncated, level = 6, ...rest } = param;
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$View$2f$View$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["View"], {
...
;
;
const TextPrimitive = (param, ref)=>{
    let { as = 'p', className, children, isTruncated, variation, ...rest } = param;
...
function useFormHandlers() {
    ...
    const handleBlur = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useFormHandlers.useCallback[handleBlur]": (param)=>{
            let { target: { name } } = param;
            updateBlur({
                name
            });
        }
    ...
    const handleChange = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useFormHandlers.useCallback[handleChange]": (param)=>{
            let { target: { checked, name, type, value } } = param;
...
/**
 * @internal For internal Amplify UI use only. May be removed in a future release.
 */ const AlertIcon = (param)=>{
    let { variation, ariaHidden, ariaLabel, role } = param;
    ...
    switch(variation){
        ...
        case 'error':
            var _icons_error;
            icon = (_icons_error = icons === null || icons === void 0 ? void 0 : icons.error) !== null && _icons_error !== void 0 ? _icons_error : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$Icon$2f$icons$2f$IconError$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IconError"], {
                "aria-hidden": ariaHidden,
                "aria-label": ariaLabel,
                role: role
            });
        ...
        case 'warning':
            var _icons_warning;
            icon = (_icons_warning = icons === null || icons === void 0 ? void 0 : icons.warning) !== null && _icons_warning !== void 0 ? _icons_warning : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$Icon$2f$icons$2f$IconWarning$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IconWarning"], {
                "aria-hidden": ariaHidden,
                "aria-label": ariaLabel,
                role: role
            });
        ...
        case 'success':
            var _icons_success;
            icon = (_icons_success = icons === null || icons === void 0 ? void 0 : icons.success) !== null && _icons_success !== void 0 ? _icons_success : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$Icon$2f$icons$2f$IconCheckCircle$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IconCheckCircle"], {
                "aria-hidden": ariaHidden,
                "aria-label": ariaLabel,
                role: role
            });
 ...
 */ const IconClose = (props)=>{
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$View$2f$View$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["View"], {
        as: "span",
        width: size !== null && size !== void 0 ? size : '1em',
        height: size !== null && size !== void 0 ? size : '1em',
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2f$dist$2f$esm$2f$utils$2f$classNames$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["classNames"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2f$dist$2f$esm$2f$types$2f$primitives$2f$componentClassName$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ComponentClassName"].Icon, className),
        ...rest
    }, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"]("svg", {
        width: "24",
...
const AlertPrimitive = (param, ref)=>{
    ...
    return !dismissed ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$Flex$2f$Flex$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Flex"], {
        ...
        ref: buttonRef
    }, (_icons_close = icons === null || icons === void 0 ? void 0 : icons.close) !== null && _icons_close !== void 0 ? _icons_close : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$Icon$2f$icons$2f$IconClose$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IconClose"], {
        "aria-hidden": "true"
    }))) : null;
};
/**
...
;
;
const VisuallyHiddenPrimitive = (param, ref)=>{
    let { as = 'span', children, className, ...rest } = param;
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$View$2f$View$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["View"], {
        as: as,
...
const ShowPasswordButtonPrimitive = (param, ref)=>{
    let { fieldType, passwordIsHiddenLabel = passwordIsHidden, passwordIsShownLabel = passwordIsShown, showPasswordButtonLabel = showPassword, size, hasError, ...rest } = param;
    ...
    var _icons_visibility, _icons_visibilityOff;
    const icon = fieldType === 'password' ? (_icons_visibility = icons === null || icons === void 0 ? void 0 : icons.visibility) !== null && _icons_visibility !== void 0 ? _icons_visibility : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$Icon$2f$icons$2f$IconVisibility$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IconVisibility"], {
        "aria-hidden": "true"
    }) : (_icons_visibilityOff = icons === null || icons === void 0 ? void 0 : icons.visibilityOff) !== null && _icons_visibilityOff !== void 0 ? _icons_visibilityOff : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$Icon$2f$icons$2f$IconVisibilityOff$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IconVisibilityOff"], {
        "aria-hidden": "true"
    });
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$Button$2f$Button$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
...
const FieldDescription = (param)=>{
    let { descriptiveText, labelHidden, ...rest } = param;
    return descriptiveText ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$Text$2f$Text$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Text"], {
...
;
;
const FieldErrorMessage = (param)=>{
    let { errorMessage, hasError, ...rest } = param;
...
;
;
const FieldGroupPrimitive = (param, ref)=>{
    let { children, className, innerEndComponent, innerStartComponent, orientation = 'horizontal', outerEndComponent, outerStartComponent, variation, ...rest } = param;
...
;
;
const InputPrimitive = (param, ref)=>{
    let { autoComplete, checked, className, defaultChecked, defaultValue, id, isDisabled, isReadOnly, isRequired, size, type = 'text', hasError = false, value, variation, ...rest } = param;
...
;
;
const LabelPrimitive = (param, ref)=>{
    let { children, className, visuallyHidden, ...rest } = param;
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$View$2f$View$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["View"], {
        as: "label",
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2f$dist$2f$esm$2f$utils$2f$classNames$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["classNames"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2f$dist$2f$esm$2f$types$2f$primitives$2f$componentClassName$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ComponentClassName"].Label, className, {
 ...
 */ const useLayoutEffect = ((_globalThis = globalThis) === null || _globalThis === void 0 ? void 0 : _globalThis.document) ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLayoutEffect"] : ()=>{};
;
}),
 ...
 */ const useStableId = (id)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$utils$2f$useLayoutEffect$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useLayoutEffect"])({
        "useStableId.useLayoutEffect": ()=>{
            if (!id) {
                setStableId({
                    "useStableId.useLayoutEffect": (reactId)=>reactId !== null && reactId !== void 0 ? reactId : String(count++)
                }["useStableId.useLayoutEffect"]);
            }
        }
    }["useStableId.useLayoutEffect"], [
    ...
    return id !== null && id !== void 0 ? id : stableId ? "".concat(AUTO_GENERATED_ID_PREFIX, "-").concat(stableId) : '';
};
;
}),
...
const getUniqueComponentId = (id, suffix)=>id && suffix ? "".concat(id, "-").concat(suffix) : undefined;
;
}),
...
;
;
const PasswordFieldPrimitive = (param, ref)=>{
    let { autoComplete = 'current-password', label, className, hideShowPassword = false, passwordIsHiddenLabel, passwordIsShownLabel, showPasswordButtonLabel, showPasswordButtonRef, size, hasError, ...rest } = param;
...
;
;
const SelectPrimitive = (param, ref)=>{
    let { autoComplete, className, size, variation, value, defaultValue, hasError, icon, iconColor, children, placeholder, isDisabled, isRequired, isMultiple = false, selectSize = 1, ...rest } = param;
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$View$2f$View$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["View"], {
        ...
        color: iconColor,
        "aria-hidden": "true"
    }, (_ref = icon !== null && icon !== void 0 ? icon : icons === null || icons === void 0 ? void 0 : icons.expand) !== null && _ref !== void 0 ? _ref : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$Icon$2f$icons$2f$IconExpandMore$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["IconExpandMore"], null)));
};
...
;
;
const selectFieldChildren = (param)=>{
    ...
    return options === null || options === void 0 ? void 0 : options.map((option, index)=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"]("option", {
            label: option,
            value: option,
...
;
;
const DialCodeSelectPrimitive = (param, ref)=>{
    let { className, dialCodeList, isReadOnly, ...props } = param;
    const dialList = dialCodeList !== null && dialCodeList !== void 0 ? dialCodeList : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2f$dist$2f$esm$2f$i18n$2f$country$2d$dial$2d$codes$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["countryDialCodes"];
...
;
;
const ValidationErrors = (param)=>{
    let { errors, id, dataAttr } = param;
    if (!((errors === null || errors === void 0 ? void 0 : errors.length) > 0)) return null;
...
function FormField(param) {
    ...
    const hasError = (errors === null || errors === void 0 ? void 0 : errors.length) > 0;
...
function FormFields() {
    const { fields } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2d$core$2f$dist$2f$esm$2f$Authenticator$2f$hooks$2f$useAuthenticator$2f$useAuthenticator$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__useAuthenticator$3e$__["useAuthenticator"])({
        "FormFields.useAuthenticator": (param)=>{
            let { route } = param;
            return [
                route
            ];
...
;
;
function RouteContainer(param) {
    let { children, className, variation = 'default' } = param;
    const { route } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2d$core$2f$dist$2f$esm$2f$Authenticator$2f$hooks$2f$useAuthenticator$2f$useAuthenticator$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__useAuthenticator$3e$__["useAuthenticator"])({
        "RouteContainer.useAuthenticator": (param)=>{
            let { route } = param;
            return [
                route
            ];
...
function ConfirmSignUp(param) {
    let { className, variation } = param;
...
const SetupTotp = (param)=>{
    ...
    const { totpIssuer = 'AWSCognito', totpUsername = username } = QRFields !== null && QRFields !== void 0 ? QRFields : {};
...
;
;
const TabsItemPrimitive = (param, ref)=>{
    let { className, value, children, onClick, as = 'button', role = 'tab', ...rest } = param;
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$View$2f$View$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["View"], {
        ...
        role: role,
        as: as,
        id: "".concat(groupId, "-tab-").concat(idValue),
        "aria-selected": isActive,
        "aria-controls": "".concat(groupId, "-panel-").concat(idValue),
...
const TabListPrimitive = (param, ref)=>{
    let { className, children, indicatorPosition, spacing, role = 'tablist', ...rest } = param;
    ...
    const nextTab = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"]({
        "TabListPrimitive.useCallback[nextTab]": ()=>{
            ...
            var _internalRef_current_querySelectorAll;
            const elems = (_internalRef_current_querySelectorAll = (_internalRef_current = internalRef.current) === null || _internalRef_current === void 0 ? void 0 : _internalRef_current.querySelectorAll('button')) !== null && _internalRef_current_querySelectorAll !== void 0 ? _internalRef_current_querySelectorAll : [];
            ...
            if (value) {
                ...
                elem === null || elem === void 0 ? void 0 : elem.click();
            }
        }
    }["TabListPrimitive.useCallback[nextTab]"], [
        currentIndex,
...
;
;
const TabPanelPrimitive = (param, ref)=>{
    let { className, value, children, role = 'tabpanel', ...rest } = param;
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$View$2f$View$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["View"], {
        ...rest,
        role: role,
        id: "".concat(groupId, "-panel-").concat(idValue),
        "aria-labelledby": "".concat(groupId, "-tab-").concat(idValue),
...
;
;
const TabsContainerPrimitive = (param, ref)=>{
    let { children, defaultValue, className, value: controlledValue, onValueChange, isLazy, ...rest } = param;
    ...
    const activeTab = isControlled ? controlledValue : localValue !== null && localValue !== void 0 ? localValue : '';
...
;
;
const TabsPrimitive = (param, ref)=>{
    let { items, indicatorPosition, justifyContent, spacing, ...rest } = param;
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$Tabs$2f$TabsContainer$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["TabsContainer"], {
        ...
        justifyContent: justifyContent,
        spacing: spacing
    }, items === null || items === void 0 ? void 0 : items.map((param)=>{
        let { value, label, content, ...rest } = param;
        ...
        let { value, content, isDisabled } = param;
...
;
;
const DividerPrimitive = (param, ref)=>{
    let { className, orientation = 'horizontal', size, label, ...rest } = param;
...
const IconPrimitive = (param, ref)=>{
    let { className, // as can be used to render other icon react components too
    as = 'svg', fill = 'currentColor', pathData, viewBox = defaultViewBox, children, paths, ...rest } = param;
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$View$2f$View$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["View"], {
        ...
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2f$dist$2f$esm$2f$utils$2f$classNames$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["classNames"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2f$dist$2f$esm$2f$types$2f$primitives$2f$componentClassName$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ComponentClassName"].Icon, className),
        ref: ref,
        viewBox: "".concat(minX, " ").concat(minY, " ").concat(width, " ").concat(height),
        ...rest
    }, _children);
};
/**
...
function FederatedSignIn() {
    const { route, socialProviders } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2d$core$2f$dist$2f$esm$2f$Authenticator$2f$hooks$2f$useAuthenticator$2f$useAuthenticator$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__useAuthenticator$3e$__["useAuthenticator"])({
        "FederatedSignIn.useAuthenticator": (param)=>{
            let { route, socialProviders } = param;
            return [
                route,
                socialProviders
            ];
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createElement(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$Flex$2f$Flex$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Flex"], {
        ...
        switch(provider){
            ...
            default:
                // eslint-disable-next-line no-console
                console.error("Authenticator does not support ".concat(provider, ". Please open an issue: https://github.com/aws-amplify/amplify-ui/issues/choose"));
        }
...
const SignInSignUpTabs = (param)=>{
    let { className, hideSignUp, variation } = param;
...
const TwoButtonSubmitFooter = (props)=>{
    ...
    const submitText = submitButtonText !== null && submitButtonText !== void 0 ? submitButtonText : defaultSubmitText;
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createElement(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$Flex$2f$Flex$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Flex"], {
        direction: "column"
    }, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].createElement(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$Button$2f$Button$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
        variation: "primary",
...
;
;
const RadioPrimitive = (param, ref)=>{
    let { children, className, id, isDisabled = false, testId, value, labelPosition: radioLabelPosition, ...rest } = param;
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createElement"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$Flex$2f$Flex$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Flex"], {
        as: "label",
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2f$dist$2f$esm$2f$utils$2f$classNames$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["classNames"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2f$dist$2f$esm$2f$types$2f$primitives$2f$componentClassName$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ComponentClassName"].Radio, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2f$dist$2f$esm$2f$utils$2f$utils$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["classNameModifierByFlag"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2f$dist$2f$esm$2f$types$2f$primitives$2f$componentClassName$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ComponentClassName"].Radio, "disabled", shouldBeDisabled), labelPosition ? "amplify-label-".concat(labelPosition) : null, className)
...
;
;
const FieldsetPrimitive = (param, ref)=>{
    let { children, className, isDisabled, legend, legendHidden, size, testId, variation = 'plain', ...rest } = param;
    const { isFieldsetDisabled } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$Fieldset$2f$useFieldset$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFieldset"])();
...
;
;
const RadioGroupFieldPrimitive = (param, ref)=>{
    let { children, className, defaultValue, descriptiveText, errorMessage, hasError = false, id, isDisabled, isRequired, isReadOnly, legend, legendHidden = false, labelPosition, onChange, name, size, testId, value, variation, ...rest } = param;
    const fieldId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$utils$2f$useStableId$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStableId"])(id);
    const stableId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$utils$2f$useStableId$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStableId"])();
    const descriptionId = descriptiveText ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$utils$2f$getUniqueComponentId$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUniqueComponentId"])(stableId, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$helpers$2f$constants$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DESCRIPTION_SUFFIX"]) : undefined;
    const errorId = hasError ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$utils$2f$getUniqueComponentId$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUniqueComponentId"])(stableId, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$helpers$2f$constants$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ERROR_SUFFIX"]) : undefined;
...
const generateRadioGroup = (attributes)=>{
    return Object.entries(attributes).map((param, index)=>{
        let [key, value] = param;
...
const VerifyUser = (param)=>{
    ...
    const { isPending, unverifiedUserAttributes } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2d$core$2f$dist$2f$esm$2f$Authenticator$2f$hooks$2f$useAuthenticator$2f$useAuthenticator$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__useAuthenticator$3e$__["useAuthenticator"])({
        "VerifyUser.useAuthenticator": (param)=>{
            let { isPending, unverifiedUserAttributes } = param;
            return [
                isPending,
...
function Header() {
    const { challengeName } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2d$core$2f$dist$2f$esm$2f$Authenticator$2f$hooks$2f$useAuthenticator$2f$useAuthenticator$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__useAuthenticator$3e$__["useAuthenticator"])({
        "Header.useAuthenticator": (param)=>{
            let { challengeName } = param;
            return [
                challengeName
            ];
        }
...
const ConfirmResetPassword = (param)=>{
    let { className, variation } = param;
    const { isPending } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2d$core$2f$dist$2f$esm$2f$Authenticator$2f$hooks$2f$useAuthenticator$2f$useAuthenticator$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__useAuthenticator$3e$__["useAuthenticator"])({
...
const getRouteComponent = (route)=>{
    switch(route){
        ...
        default:
            // eslint-disable-next-line no-console
            console.warn("Unhandled Authenticator route - please open an issue: ".concat(route));
            return RenderNothing;
    }
};
...
function AuthenticatorInternal(param) {
    let { children, className, components: customComponents, formFields, hideSignUp, initialState, loginMechanisms, passwordSettings, signUpAttributes, services, socialProviders, variation } = param;
    ...
    const { route, signOut, user } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2d$core$2f$dist$2f$esm$2f$Authenticator$2f$hooks$2f$useAuthenticator$2f$useAuthenticator$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__useAuthenticator$3e$__["useAuthenticator"])({
        "AuthenticatorInternal.useAuthenticator": (param)=>{
            let { route, signOut, user } = param;
            return [
                route,
                signOut,
                user
...
"[project]/node_modules/@aws-amplify/ui-react/dist/esm/primitives/Image/Image.mjs [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const ImagePrimitive = (param, ref)=>{
 ...
 */ const Image = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$ui$2d$react$2f$dist$2f$esm$2f$primitives$2f$utils$2f$primitiveWithForwardRef$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["primitiveWithForwardRef"])(ImagePrimitive);
 ...
 */ function ThemeProvider(param) {
    let { children, colorMode, direction = 'ltr', nonce, theme } = param;
    const value = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"]({
...
//# sourceMappingURL=node_modules_%40aws-amplify_ui-react_dist_esm_0b5ec621._.js.map